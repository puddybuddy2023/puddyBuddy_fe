...
class LegMeasure extends StatefulWidget {
  const LegMeasure({super.key});

  @override
  State<LegMeasure> createState() => _LegMeasureState();
}

class _LegMeasureState extends State<LegMeasure> {
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    '강아지 겨드랑이에서 발목까지의 길이를 잽니다.\n강아지 사이즈가 애매할 때는 가슴둘레 > 목둘레 > 등길이 순으로 선택하는 것이 좋습니다.',
